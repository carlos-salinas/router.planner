...
public class RouteForm extends CustomComponent implements ValueChangeListener {
	...
	@AutoGenerated
	private InlineDateField routeTimeInlineDateField;
	@AutoGenerated
...
//	private static final String AVOID_
	...
	public RouteForm() {
		...
		routeTimeInlineDateField.setStyleName("bolder");
	...
	private void addRoutingOptions(MapQuestOpenDirectionsService mapQuestOpenDirectionsService){
		...
		selectedStartingRouteDate = (Date) routeTimeInlineDateField.getValue();
		
		if(selectedStartingRouteDate == null)
			selectedStartingRouteDate = new Date();
	...
	private VerticalLayout buildVerticalLayout_1() {
		...
		// inlineDateField_1
		routeTimeInlineDateField = new InlineDateField();
		routeTimeInlineDateField.setCaption("Fecha de inicio"); 
		routeTimeInlineDateField.setImmediate(false);
		routeTimeInlineDateField.setWidth("100.0%");
		routeTimeInlineDateField.setHeight("-1px");
		routeTimeInlineDateField.setInvalidAllowed(false);
		routeTimeInlineDateField.setResolution(2);
		verticalLayout_1.addComponent(routeTimeInlineDateField);
