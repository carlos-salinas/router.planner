...
import com.thingtrack.route.planner.ui.CustomizedLocationTextField;
...
public class RoutePlannerLayout extends CustomComponent implements
	...
	public RoutePlannerLayout() {
		...
		routeForm_1 = new RouteForm(this);
	...
	private void createMarkerPopups(Route route, Date startingRouteDate,
		...
		for (int i = 0; i < markers.size(); i++) {
			...
			if (i == 0) {
				...
				if(markers.size() - i == 1)
					customizedLocationTextFields.get(i).setArrivalStopDate(calendar.getTime());
				
				else setStopDate(customizedLocationTextFields.get(i), calendar.getTime());
